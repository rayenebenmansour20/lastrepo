...
import 'listproduitdetail.dart';

class Produitliste extends StatefulWidget {
  const Produitliste({Key? key}) : super(key: key);

  @override
  // ignore: library_private_types_in_public_api
  _ProduitlisteState createState() => _ProduitlisteState();
}

class _ProduitlisteState extends State<Produitliste> {
  int _currentPage = 0;
          ...
          // Header Row
           Expanded(
            child: ListView.builder(
              ...
              itemBuilder: (context, index) => ProduitlisteDetailDataTable(
