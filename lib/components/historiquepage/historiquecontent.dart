...
import 'listhistorique.dart';

class HistoriqueContent extends StatefulWidget {
  const HistoriqueContent({Key? key}) : super(key: key);
  
  @override
  // ignore: library_private_types_in_public_api
  _HistoriqueContentState createState()=> _HistoriqueContentState(); 
}
